namespace Class5th__Iteration_Statement_
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("전위 증가한 vector2의 값 :" + vector2);
            Console.WriteLine("vector2의 값 : " + vector2);

            vector2 = --x;

            Console.WriteLine("전위 감소한 x의 값 : " + x);
            Console.WriteLine("vector2 의 값 :" + vector2);
            ...
            Console.WriteLine("후위 증가한 y의 값 :" + y);
            ...
            // while문은 do에서 변수를 생성하고 초기화를 하게 되면
