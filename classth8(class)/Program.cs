    ...
    namespace Program 
    {
         ...
         class Program
        {
            ...
            static void Main(string[] args)
            {
                ...
                // Compaet : Sweep 이후에 분산된 객체들을 Mansged Heap의 시작 주소로
         ...
         calculator = Add;
              ...
              calculator = Multiply;
                Console.WriteLine("Divide : " + calculator(1.57f, 10.0f));
                #endregion

                Console.WriteLine("Subtraction : " + calculator(1.57f, 10.0f));
