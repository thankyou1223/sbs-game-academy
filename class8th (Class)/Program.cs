namespace class8th__Class_
{
    internal class Program
    {
        ...
        }
        {
            ...
            // 생성저의 반환형이 객체가 생성될 때 단 한 번만 호출되며,
        ...
        Item2.price = 999;
            ...
            Console.WriteLine("itme1의 price 값 : " + item1.price);
            Console.WriteLine("itme2의 price 값 : " + item2.price);
        ...
        marinel1.health = 45;
               ...
               Unit marine2 = new Unit {(marine1)long

                  Console.WriteLine("marin1의 health :")
